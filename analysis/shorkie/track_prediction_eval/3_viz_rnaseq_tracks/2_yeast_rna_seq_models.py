...
def get_models_for_fold(fold_param, seq_len, target_index, root_dir):
    ...
    for model_type in ["supervised", "self_supervised"]:
        ...
        if model_type == 'supervised':
            model_dir = f'{root_dir}/seq_experiment/exp_histone__chip_exo__rna_seq_no_norm_5215_tracks/16bp/supervised_unet_small_bert_drop_variants/learning_rate_0.0005'
        else:
            model_dir = f'{root_dir}/seq_experiment/exp_histone__chip_exo__rna_seq_no_norm_5215_tracks/16bp/{model_type}_unet_small_bert_drop'

        params_file = f'{model_dir}/train/{fold_param}/train/params.json'
        model_file  = f'{model_dir}/train/{fold_param}/train/model_best.h5'
...
def plot_cov_plot(
    ...
    #    e.g.  ./viz_tracks/f4c0/chrIV/YDR424C_mRNA/exonCount_3/RNA-seq/range_1319387_1319841
    save_dir = f'./viz_tracks/{fold_param}/exonCount_{exon_count}/{chrom}/{search_gene}/{dataset_type}/range_{region_start}_{region_end}'
