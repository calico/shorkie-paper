...
exp_type=gene_exp_motif_test_${target_tf}_targets/f0c0/
dataset=../gene_exp_motif_test_${target_tf}_targets/f0c0/part${SLURM_ARRAY_TASK_ID}

# I want preserve 2 digits for the bed file
bed_file=${bed_file_root}${target_tf}_targets_chunk/${target_tf}_targets_windows_$(printf "%02d" $SLURM_ARRAY_TASK_ID).bed

# Run the Python script
python 0_timepoint_viz_coverage.py \
    --exp_dir ${dataset} \
