...
def main():
    ...
    tsv = "/home/kchao10/scr4_ssalzbe1/khchao/Yeast_ML/data/eQTL_kita_etal/fix/selected_eQTL/intersected_CIS.tsv"
    df = pd.read_csv(tsv, sep="\t", dtype=str)

    # parse numeric positions
    center_series = pd.to_numeric(df["position"], errors="coerce").astype("Int64")
    ...
    for idx, raw_alt in df["Alternate"].fillna("").iteritems():
        ...
        for alt in single_nts:
            genes_out.append(df.at[idx, "#Gene"])
