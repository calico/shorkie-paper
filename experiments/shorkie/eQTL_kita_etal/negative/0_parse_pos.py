...
def main():
    ...
    for neg_set in range(1, 5):
        tsv = f"/home/kchao10/scr4_ssalzbe1/khchao/Yeast_ML/experiments/SUM_data_process/eQTL_kita_etal_select_exp_pseudo_negatives/results/negative_eqtls_set{neg_set}.tsv"
