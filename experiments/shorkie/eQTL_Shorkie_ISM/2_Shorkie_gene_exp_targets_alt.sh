...
output_dir="gene_exp_motif_${exp_data}_alt/${fold_param}/${SLURM_ARRAY_TASK_ID}/"
...
# bed_file="/home/kchao10/scr4_ssalzbe1/khchao/Yeast_ML/experiments/SUM_data_process/eQTL_Shorkie_ISM/results/output_variants_80bp_selected.bed"

bed_file_dir="/home/kchao10/scr4_ssalzbe1/khchao/Yeast_ML/experiments/SUM_data_process/eQTL_Shorkie_ISM/results/output_variants_80bp/"
bed_file="${bed_file_dir}output_variants_80bp_windows_$(printf "%03d" ${SLURM_ARRAY_TASK_ID}).bed"


tsv_file=/home/kchao10/scr4_ssalzbe1/khchao/Yeast_ML/data/eQTL/selected_eQTL/intersected_data_CIS.tsv

echo "Using bed file: $bed_file"

# Run the command
python /home/kchao10/scr4_ssalzbe1/khchao/Yeast_ML/baskerville-yeast/src/baskerville/scripts/hound_ism_bed_snp.py \
