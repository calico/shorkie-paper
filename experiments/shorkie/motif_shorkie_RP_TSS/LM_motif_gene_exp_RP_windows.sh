...
current_experiment="/home/kchao10/scr4_ssalzbe1/khchao/Yeast_ML/seq_experiment/${fine_tuned_model_type}/16bp/train_prev/self_supervised_unet_small_bert_drop/train/${fold_param}/train"
