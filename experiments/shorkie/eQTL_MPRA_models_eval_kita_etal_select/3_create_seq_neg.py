...
for negset in negsets:
    ...
    tsv_file = f"/home/kchao10/scr4_ssalzbe1/khchao/Yeast_ML/experiments/SUM_data_process/eQTL_kita_etal_select_exp_pseudo_negatives/results/negative_eqtls_set{negset}.tsv"
