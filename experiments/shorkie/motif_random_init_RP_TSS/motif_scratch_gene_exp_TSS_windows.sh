...
current_experiment="/home/kchao10/scr4_ssalzbe1/khchao/Yeast_ML/seq_experiment/${fine_tuned_model_type}/16bp/train_prev/supervised_unet_small_bert_drop/train/${fold_param}/train"
...
python /home/kchao10/scr4_ssalzbe1/khchao/Yeast_ML/baskerville-yeast/src/baskerville/scripts/hound_ism_bed.py \
    ...
    /home/kchao10/scr4_ssalzbe1/khchao/Yeast_ML/seq_experiment/${fine_tuned_model_type}/16bp/supervised_unet_small_bert_drop/train/${fold_param}/train/params.json \
    /home/kchao10/scr4_ssalzbe1/khchao/Yeast_ML/seq_experiment/${fine_tuned_model_type}/16bp/supervised_unet_small_bert_drop/train/${fold_param}/train/model_best.h5 \
    /home/kchao10/scr4_ssalzbe1/khchao/Yeast_ML/data/gene_exp_ism_window/TSS_chunk/TSS_windows_0${SLURM_ARRAY_TASK_ID}.bed \
