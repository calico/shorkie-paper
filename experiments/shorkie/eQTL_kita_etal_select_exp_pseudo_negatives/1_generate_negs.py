...
def parse_gwas(gwas_file):
    ...
    Columns required: Chr, ChrPos, Reference, Alternate, #Gene
...
if __name__ == "__main__":
    ...
    """
    gwas_file = "/home/kchao10/scr4_ssalzbe1/khchao/Yeast_ML/data/eQTL_kita_etal/fix/selected_eQTL/intersected_CIS.tsv"
