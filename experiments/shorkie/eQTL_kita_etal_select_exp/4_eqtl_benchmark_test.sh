...
#SBATCH --array=0-7  # Array to iterate over 8 folds (0 to 7)
...
output_root_dir="eqtls/"
output_dir="${output_root_dir}eqtl_${fold_param}/"
...
eQTL_VCF="/home/kchao10/scr4_ssalzbe1/khchao/Yeast_ML/data/eQTL_kita_etal/fix/selected_eQTL/updated_intersected_CIS.vcf"
