...
experiments=(
    ...
    # "lm_saccharomycetales_gtf_unet_small"
    # "lm_saccharomycetales_gtf_unet_small_retry_1"
    # "lm_saccharomycetales_gtf_unet_small_retry_2"
    # "lm_saccharomycetales_gtf_unet_small_bert_aux_drop"
    # "lm_saccharomycetales_gtf_unet_small_bert_aux_drop_retry_1"
    # "lm_saccharomycetales_gtf_unet_small_bert_aux_drop_retry_2"
)
