...
python 1_modisco_DNA_logo.py --modisco_h5 /home/kchao10/scr4_ssalzbe1/khchao/Yeast_ML/experiments/motif_LM/saccharomycetales_viz_seq/unet_small_bert_drop/modisco_results_w16384_n100000.h5 \
    --out_dir $out_dir/ \
    --seq_bed ${bedfile} \
