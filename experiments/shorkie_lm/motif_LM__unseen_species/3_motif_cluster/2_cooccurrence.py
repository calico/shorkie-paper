...
if __name__ == "__main__":
    # experiment = "schizosaccharomycetales_viz_seq"
    experiment = "strains_select_viz_seq"
    # Path to the TF-MoDISco results HDF5 file.
    modisco_h5 = f"/home/kchao10/scr4_ssalzbe1/khchao/Yeast_ML/experiments/motif_LM__unseen_species/{experiment}/unet_small_bert_drop/modisco_results_w_16384_n_1000000.h5"
    
    # Path to the motifs.html file for motif mapping.
    motifs_html = f"/home/kchao10/scr4_ssalzbe1/khchao/Yeast_ML/experiments/motif_LM__unseen_species/{experiment}/unet_small_bert_drop/report_w_16384_n_1000000/motifs.html"
    ...
    output_dir = f"{experiment}_results/"
