...
# def plot_venn(fasta_files, condition1, condition2, output_dir):
...
#     venn3(sets, (condition1, 'ENSEMBLE release', condition2))
...
# # Example usage:
# file1_1 = '/scratch4/khc/yeast_ssm/data/yeast/ensembl_fungi_59/data_r64_mm_gtf/fasta/GCA_000146045_2.cleaned.fasta.masked'
# file1_2 = '/scratch4/khc/yeast_ssm/data/yeast/ensembl_fungi_59/data_r64_mm_gtf/fasta/GCA_000146045_2.cleaned.fasta.masked.dust.softmask'
# file1s = [file1_1, file1_2]
# file1s_condition = ['RepeatMasker \n(Hmmer + Dfam)', 'RepeatMasker \n(Hmmer + Dfam) + Dust']

# file2 = '/scratch4/khc/yeast_ssm/data/yeast/ensembl_fungi_59/data_r64_sm_gtf/fasta/GCA_000146045_2.cleaned.fasta'

# file3_1 = '/scratch4/khc/yeast_ssm/data/yeast/ensembl_fungi_59/data_r64_rmblast_dfam_gtf/fasta/GCA_000146045_2.cleaned.fasta.masked'
# file3_2 = '/scratch4/khc/yeast_ssm/data/yeast/ensembl_fungi_59/data_r64_rmblast_dfam_gtf/fasta/GCA_000146045_2.cleaned.fasta.masked.dust.softmask'
# # file3_3 = '/scratch4/khc/yeast_ssm/data/yeast/ensembl_fungi_59/data_r64_rmblastn_gtf/fasta/GCA_000146045_2.cleaned.fasta.masked'
# # file3_4 = '/scratch4/khc/yeast_ssm/data/yeast/ensembl_fungi_59/data_r64_rmblastn_gtf/fasta/GCA_000146045_2.cleaned.fasta.masked.dust.softmask'
# # file3s_condition = ['RepeatModeler (RMBlast + RepBase)', 'RepeatModeler (RMBlast + RepBase) + Dust', 'RepeatMasker (RMBlast + RepBase)', 'RepeatMasker (RMBlast + RepBase) + Dust']

# # file3s = [file3_1, file3_2, file3_3, file3_4]

# file3s_condition = ['RepeatModeler (RMBlast + Dfam)', 'RepeatModeler (RMBlast + Dfam) + Dust']

# file3s = [file3_1, file3_2]

# output_dir = '.'

# for i, file1 in enumerate(file1s):
#     for j, file3 in enumerate(file3s):
#         fasta_files = [file1, file2, file3]
#         condition1 = file1s_condition[i]
#         condition2 = file3s_condition[j]
#         print(f'Plotting Venn diagram for {condition1} vs {condition2}')
#         plot_venn(fasta_files, condition1, condition2, output_dir)


# # # Replace 'file1.fasta', 'file2.fasta', 'file3.fasta' with your actual file paths

# # regions1 = get_masked_regions(file1)
# # regions2 = get_masked_regions(file2)
# # regions3 = get_masked_regions(file3)

# # print('Number of masked regions in File1:', regions1)
# # # # Plotting the Venn diagram
# # # venn3([regions1, regions2, regions3], ('File1', 'File2', 'File3'))
# # # plt.title('Venn Diagram of Masked Repeat Regions')
# # # plt.show()
import matplotlib.pyplot as plt
...
# colors = plt.cm.viridis(np.linspace(0, 1, len(precision_list)))
# colors = plt.cm.plasma(np.linspace(0, 1, len(precision_list)))
