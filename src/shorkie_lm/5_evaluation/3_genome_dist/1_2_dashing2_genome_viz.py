...
def main(data_type):
    ...
    # SEQ_BED = f"/scratch4/khc/yeast_ssm/data/yeast/ensembl_fungi_59/data_{data_type}/sequences.bed"
    # SEQ_BED_DIR = f"/scratch4/khc/yeast_ssm/data/yeast/ensembl_fungi_59/data_{data_type}/sequences_train_split"
    ...
    for output_target in output_targets:
        ...
        if number is not None:
            ...
            # target_name= output_file.split("_")[2].split(".")[0]
...
if __name__ == "__main__":
    ...
    #     number = parse_file_content(content)
    #     if number is not None:
    #         data[file_name] = number
    ...
    # # plt.xlabel('File')
    # # plt.ylabel('Value')
    # # plt.title('Parsed Values from Files')
...
# # Mimic reading multiple files
# file_names = ["file1.txt", "file2.txt", "file3.txt"]
# parsed_data = {
#     "file1.txt": file_contents,
#     "file2.txt": file_contents,
#     "file3.txt": file_contents
# }
