...
OUTPUT_DIR="/scratch4/khc/yeast_ssm/results/ensembl_fungi_59/${data_type}/genome_dist/${data_type}/dashing2"
...
for fasta_file in "$FASTA_DIR"/*.cleaned.fasta; do
    ...
    echo " ${OUTPUT_DIR}/${data_type}_${ref_base_name}_${base_name}.txt"

    # mkdir -p ${OUTPUT_DIR}
    
    # /home/khc/bin/dashing2 sketch ${REF_FASTA} \
    # ${fasta_file} \
