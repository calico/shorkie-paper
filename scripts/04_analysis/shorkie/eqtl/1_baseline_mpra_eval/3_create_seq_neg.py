...
parser = argparse.ArgumentParser(description="Extract negative sequences.")
parser.add_argument("--tsv_prefix", required=True, help="Prefix path for negative TSVs (e.g. data/negative_eqtls_set)")
...
for negset in negsets:
    tsv_file = f"{args.tsv_prefix}{negset}.tsv"
    fasta_file = args.fasta_file
    gtf_file = args.gtf_file
    output_tsv = os.path.join(args.output_dir, f"output_neg_sequences_{negset}.tsv")
