...
if __name__ == "__main__":
    ...
    positive_file = f"{WORK_ROOT}/experiments/SUM_data_process/MPRA/results/single_measurement_stranded/viz/expression_vs_position/aggregated_positive_by_seq_type.png"
    negative_file = f"{WORK_ROOT}/experiments/SUM_data_process/MPRA/results/single_measurement_stranded/viz/expression_vs_position/aggregated_negative_by_seq_type.png"
    output_merged_file = f"{WORK_ROOT}/experiments/SUM_data_process/MPRA/results/single_measurement_stranded/viz/expression_vs_position/merged_aggregated_by_seq_type.png"
