...
current_experiment="${WORK_ROOT}/seq_experiment/${fine_tuned_model_type}/16bp/train_prev/self_supervised_unet_small_bert_drop_v1/train/${fold_param}/train"
...
python ${BASKERVILLE_SCRIPTS}/hound_ism_bed.py \
    ...
    ${WORK_ROOT}/seq_experiment/${fine_tuned_model_type}/16bp/self_supervised_unet_small_bert_drop_v1/train/${fold_param}/train/params.json \
    ${WORK_ROOT}/seq_experiment/${fine_tuned_model_type}/16bp/self_supervised_unet_small_bert_drop_v1/train/${fold_param}/train/model_best.h5 \
    ${WORK_ROOT}/data/gene_exp_ism_window/TSS_chunk/TSS_windows_${SLURM_ARRAY_TASK_ID_ADJ}.bed \
