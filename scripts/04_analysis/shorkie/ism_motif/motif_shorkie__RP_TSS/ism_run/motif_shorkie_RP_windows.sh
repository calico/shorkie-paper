...
current_experiment="${WORK_ROOT}/seq_experiment/${fine_tuned_model_type}/16bp/train_prev/self_supervised_unet_small_bert_drop/train/${fold_param}/train"
...
python ${BASKERVILLE_SCRIPTS}/hound_ism_bed.py \
    ...
    ${WORK_ROOT}/data/gene_exp_ism_window/RP_chunk/RP_windows_${SLURM_ARRAY_TASK_ID}.bed \
