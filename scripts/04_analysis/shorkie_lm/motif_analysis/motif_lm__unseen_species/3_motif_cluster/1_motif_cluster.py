...
if __name__ == "__main__":
    ...
    modisco_h5 = f"{WORK_ROOT}/experiments/motif_LM__unseen_species/{experiment}/unet_small_bert_drop/modisco_results_w_16384_n_1000000.h5"
    
    # Path to the motifs.html file for motif mapping.
    motifs_html = f"{WORK_ROOT}/experiments/motif_LM__unseen_species/{experiment}/unet_small_bert_drop/report_w_16384_n_1000000/motifs.html"
