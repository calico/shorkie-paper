...
def main():
    ...
    pwm_data = np.load(f"{WORK_ROOT}/experiments/dependencies_DNALM/all_prbs.npy")
    # pwm_data = np.load("${WORK_ROOT}/experiments/dependencies_DNALM/all_prbs_chrX_607855_608355.npy")
