...
def main():
    ...
    for target in ["test", "valid"]:
        aln_fn = f"{CORPUS_BUILD_RESULTS_ROOT}/ensembl_fungi_59/test_chrXI_chrXIII_chrXV__valid_chrXII_chrXIV_chrXVI/{data_type}/dataset_stats/dataset_similarity/mummer/5_viz_target_{data_type}_train_{target}.txt"
        print("aln_fn: ", aln_fn)
        ...
        plt.savefig(f"{CORPUS_BUILD_RESULTS_ROOT}/ensembl_fungi_59/test_chrXI_chrXIII_chrXV__valid_chrXII_chrXIV_chrXVI/{data_type}/dataset_stats/dataset_similarity/mummer/6_viz_target_{data_type}_train_{target}.png", dpi=300)
        plt.clf()
